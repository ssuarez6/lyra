...
#Ciclo que llena la columna solución (el lado derecho de la matriz original)
...
print tabulate(ax_full,tablefmt="fancy_grid",headers=terminos[0:numberofRows+1])
print tabulate(solvedMatrix, tablefmt="fancy_grid",headers=["solution"])
